...
```bash
curl https://m0gfw8vx7e.execute-api.us-east-1.amazonaws.com/dev/ping
```

## [Check it at dashboard](https://dashboard.serverless.com/tenants/yanghaoyuying/applications/aws-node-http-endpoint/overview/service)
